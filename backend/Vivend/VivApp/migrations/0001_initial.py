    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('alumni', 'Alumni'), ('student', 'Student'), ('admin', 'Admin')], max_length=10)),
                ('graduation', models.CharField(help_text='Graduation year, e.g., 2023', max_length=4)),
