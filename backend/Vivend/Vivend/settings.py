"""
Django settings for Vivend project.
...
SECRET_KEY = 'django-insecure-2y@p0%!y9nh#c*+dhji*gvoxzbrb-i*@l%*fiq2b3sbftl0#sz'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'VivApp', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Vivend.wsgi.application'
